...
import static com.example.guia3.VerLista.lsNombre;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnLista: {
                ...
                Intent segunda = new Intent(this, AgregarNombre.class);
            ...
            case R.id.btnVer: {
                if (!lsNombre.isEmpty()){
                    ...
                    Intent tercera = new Intent(this, VerLista.class);
            ...
            case R.id.btnDatos: {
                ...
                Intent cuarta = new Intent(this, MisDatos.class);
